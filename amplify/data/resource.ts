...
const schema = a.schema({
  RegisteredUser: a
    .model({
      ...
      trustLevel: a.integer().required().default(0), // 0=normal, 1=trusted, 2=superTrusted, 3=superAdmin
  ...
  UrlSubmission: a
    .model({
      ...
      reviewed: a.boolean().required().default(false),
      accepted: a.boolean().required().default(false),
